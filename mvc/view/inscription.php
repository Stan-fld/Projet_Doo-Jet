                ...
                <div class="login-form">
                    <form action="" method="post" class="form-horizontal ajax">
                        ...
                        <div class="form-group">
                            ...
                            <input required class="au-input au-input--full" type="text" name="num_permis" id="num_permis" placeholder="Numéro de permis : ">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input required class="au-input au-input--full" type="text" name="num_bees" id="num_bees" placeholder="Numéro BEES : ">
                        </div>
                        <div class="form-group">
