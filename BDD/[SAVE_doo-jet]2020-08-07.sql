...
--
-- Hôte : localhost:3306
-- Généré le : ven. 07 août 2020 à 17:48
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `select_equipement_dispo` (IN `vdebut` DATETIME, IN `vfin` DATETIME)  READS SQL DATA
BEGIN 
...
WHERE indispo_tb.ID_Equipement IS NULL;
...
(3, 1, '2020-08-14 13:30:00', '2020-08-14 14:00:00'),
(3, 2, '2020-08-12 11:30:00', '2020-08-12 15:00:00'),
