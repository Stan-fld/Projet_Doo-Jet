...
--
-- Hôte : localhost:3306
-- Généré le : lun. 10 août 2020 à 16:32
...
SELECT Nom, Prenom, Telephone, personne.ID_Personne, equipement_reserve.ID_Reservation, DATE_FORMAT(equipement_reserve.Date_Heure_Debut_Reservation, "%d/%m/%Y %Hh%i") as debut, DATE_FORMAT(equipement_reserve.Date_Heure_Fin_Reservation, "%d/%m/%Y %Hh%i") as fin FROM equipement_reserve
LEFT JOIN reservation_client_employe as rce ON equipement_reserve.ID_Reservation = rce.ID_Reservation
LEFT JOIN personne ON rce.ID_Personne = personne.ID_Personne
ORDER BY Date_Heure_Debut_Reservation DESC, Date_Heure_Fin_Reservation DESC;
END$$
...
(1, 2, '2020-08-13 13:30:00', '2020-08-13 14:00:00'),
(3, 3, '2020-08-14 13:00:00', '2020-08-14 14:00:00'),
(4, 3, '2020-08-14 12:00:00', '2020-08-14 12:30:00'),
(4, 4, '2020-08-15 10:00:00', '2020-08-15 10:30:00'),
(7, 4, '2020-08-15 11:00:00', '2020-08-15 11:30:00');
